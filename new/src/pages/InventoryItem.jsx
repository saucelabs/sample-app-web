...
function InventoryItem(props) {
  ...
  if (itemInCart) {
    cartButton =
      <button className="btn_secondary btn_inventory" onClick={() => removeFromCart(item.id)}>REMOVE</button>;
  } else {
    cartButton = <button className="btn_primary btn_inventory" onClick={() => addToCart(item.id)}>ADD TO CART</button>;
  }
