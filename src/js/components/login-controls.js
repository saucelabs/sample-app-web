	  ...
	  return (
		<div className="login-box">
		  <form onSubmit={this.handleSubmit}>
			  <input type="text" className="form_input" data-test="username" id="user-name" name="user-name" placeholder="Username" value={this.state.username} onChange={this.handleUserChange} autoCorrect="off" autoCapitalize="none" />
			  <input type="password" className="form_input" data-test="password" id="password" name="password" placeholder="Password" value={this.state.password} onChange={this.handlePassChange} autoCorrect="off" autoCapitalize="none" />
