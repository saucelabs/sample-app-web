...
describe('shopping-cart', () => {
  ...
  it('should be able to add an item to the cart', () => {
    ...
    expect(window.localStorage.getItem("cart-contents")).toEqual(JSON.stringify([1, 2]));
  ...
  it('should be able to remove an item from the cart', () => {
    ...
    expect(window.localStorage.getItem("cart-contents")).toEqual(JSON.stringify([1, 2, 3]));
  ...
  it('should be able to set the content in the cart', () => {
    ...
    expect(window.localStorage.getItem("cart-contents")).toEqual(JSON.stringify(items));
  });
